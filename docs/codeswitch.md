...
35–43 KB each, ~158 KB for all four). A word is scored under all four models and
...
order 2 both classifies better on this word-level task and is smaller). Training
